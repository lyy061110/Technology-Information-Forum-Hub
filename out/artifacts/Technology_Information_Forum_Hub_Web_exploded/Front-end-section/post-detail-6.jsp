...
<main class="main-container">
    ...
    <aside class="sidebar">
        <section class="sidebar-section">
            ...
            <div class="related-post" onclick="window.location.href='post-detail.jsp'">
            ...
            <div class="related-post" onclick="window.location.href='post-detail-7.jsp'">
            ...
            <div class="related-post" onclick="window.location.href='post-detail-8.jsp'">
