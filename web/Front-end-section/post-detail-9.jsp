...
<header>
    <div class="header-content">
        ...
        <nav class="nav-links">
            ...
            <a href="ai-category.jsp" class="nav-link">AI</a>
            <a href="#" class="nav-link">Web</a>
            <a href="#" class="nav-link">Mobile</a>
            <a href="#" class="nav-link">Data Science</a>
            <a href="create-post.jsp" class="nav-link">Create Post</a>
        </nav>
...
<main class="main-container">
    <div class="breadcrumb">
        <a href="index.jsp">Home</a> / <a href="ai-category.jsp">AI</a> / The Bias Problem in AI Systems: Detection and Mitigation
    </div>
        ...
        <header class="post-header">
            ...
            <div class="post-meta">
                <div class="post-author-info">
                    ...
                    <div>
                        <div style="font-weight: 600; color: #333;">Ethics Researcher</div>
                        <div style="color: #666; font-size: 12px;">AI Ethics Specialist</div>
                    </div>
                </div>
        ...
        <div class="comments-list">
            <div class="comment">
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (28)</a>
                    <a href="#" class="comment-action" onclick="replyComment()">💬 回复</a>
                    <a href="#" class="comment-action" onclick="shareComment()">🔗 分享</a>
                </div>
            </div>
            ...
            <div class="comment">
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (15)</a>
                    <a href="#" class="comment-action" onclick="replyComment()">💬 回复</a>
                    <a href="#" class="comment-action" onclick="shareComment()">🔗 分享</a>
                </div>
            </div>
            ...
            <div class="comment">
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (22)</a>
                    <a href="#" class="comment-action" onclick="replyComment()">💬 回复</a>
                    <a href="#" class="comment-action" onclick="shareComment()">🔗 分享</a>
                </div>
            </div>
...
<script>
    ...
    function submitComment() {
        ...
        newComment.innerHTML = `
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (0)</a>
                    <a href="#" class="comment-action" onclick="replyComment()">💬 回复</a>
                    <a href="#" class="comment-action" onclick="shareComment()">🔗 分享</a>
                </div>
            `;
