...
<main class="main-container">
    <div class="breadcrumb">
        <a href="index.jsp">Home</a> / <a href="ai-category.jsp">AI</a> / YOLOv8 vs Faster R-CNN: 目标检测算法深度对比分析
    </div>
        ...
        <header class="post-header">
            ...
            <div class="post-meta">
                <div class="post-author-info">
                    ...
                    <div>
                        <div style="font-weight: 600; color: #333;">李伟</div>
                        <div style="color: #666; font-size: 12px;">计算机视觉工程师</div>
                    </div>
                </div>
        ...
        <div class="comments-list">
            <div class="comment">
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (32)</a>
            ...
            <div class="comment">
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (18)</a>
                    <a href="#" class="comment-action" onclick="replyComment()">💬 回复</a>
                    <a href="#" class="comment-action" onclick="shareComment()">🔗 分享</a>
                </div>
            </div>
            ...
            <div class="comment">
                ...
                <div class="comment-actions">
                    <a href="#" class="comment-action" onclick="likeComment(this)">👍 点赞 (24)</a>
                    <a href="#" class="comment-action" onclick="replyComment()">💬 回复</a>
                    <a href="#" class="comment-action" onclick="shareComment()">🔗 分享</a>
                </div>
            </div>
